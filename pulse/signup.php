...
if(isset($_POST['signup'])) {
  ...
  $dob = $_POST['dob'];
  $gender = $_POST['gender_option']; // Corrected name attribute
  $phone = $_POST['phone'];
  $address = $_POST['address'];
  $insurance_info = $_POST['insurance_info'];
  $emergency_contact = $_POST['emergency_contact'];

  $query = "INSERT INTO logindetails (fullname,email,PASSWORD,dob,gender,phone,address,insurance_info,emergency_contact) VALUES('$name','$email','$password','$dob','$gender','$phone','$address','$insurance_info','$emergency_contact')";
